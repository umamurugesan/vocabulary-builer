...
public String toString() {
	return "Pronunciation [audioFile=" + audioFile + ", dialects=" + dialects + ", phoneticNotation=" + phoneticNotation
			+ ", phoneticSpelling=" + phoneticSpelling + ", additionalProperties=" + additionalProperties + "]";
}
