...
@Override
	public String toString() {
		return "Entry [etymologies=" + etymologies + ", grammaticalFeatures=" + grammaticalFeatures
				+ ", homographNumber=" + homographNumber + ", senses=" + senses + ", additionalProperties="
...
private List<com.example.jsonformat.GrammaticalFeature> grammaticalFeatures = null;
